...
const navItems: NavItem[] = [
  {
    icon: <GridIcon />,
    name: "Dashboard",
    subItems: [{ name: "Attendance", path: "/", pro: false }],
  },
  // {
  //   icon: <CalenderIcon />,
  //   name: "Calendar",
  ...
  
  {
    ...
    subItems: [
      ...
      { name: "Cabang Perusahaan", path: "/admin/tabel-cabang", pro: false},
      { name: "Department", path: "/admin/tabel-department", pro: false},
      { name: "Job Posisi", path: "/admin/tabel-posisi", pro: false},
      { name: "Shift Kerja", path: "/admin/tabel-shift", pro: false}
    ],
  },
  {
    name: "Absensi",
    ...
    subItems: [
      ...
      { name: "Perizinan", path: "/admin/tabel-perizinan", pro: false},
      { name: "History Absensi", path: "/admin/tabel-absen", pro: false},
      { name: "History Approve", path: "/admin/tabel-approval", pro: false}
    ],
  },
  {
    icon: <UserCircleIcon />,
